...
(function (factory) {
  ...
  function createTemplateCompiler() {
    ...
    return function (text) {
      ...
      bag.push('}', 'return _.join(\'\')'); // eslint-disable-next-line no-new-func
  ...
  return {
    ...
    enableAlternativeTemplateTags: function enableAlternativeTemplateTags(value) {
      _enableAlternativeTemplateTags = value;
    },
    warnBug17028: function warnBug17028() {
      _warnBug = true;
    },
