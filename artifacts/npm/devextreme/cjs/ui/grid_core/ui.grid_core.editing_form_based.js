      ...
      editing: {
        ...
        optionChanged: function optionChanged(args) {
          if (args.name === 'editing' && this.isFormOrPopupEditMode()) {
            ...
            if ((fullName === null || fullName === void 0 ? void 0 : fullName.indexOf(_uiGrid_core.EDITING_POPUP_OPTION_NAME)) === 0) {
              if (editPopup) {
            ...
            } else if (editPopup !== null && editPopup !== void 0 && editPopup.option('visible') && fullName.indexOf('editing.form') === 0) {
              this._repaintEditPopup();
            }
        ...
        _beforeEndSaving: function _beforeEndSaving() {
          ...
          if (this.isPopupEditMode()) {
            ...
            (_this$_editPopup4 = this._editPopup) === null || _this$_editPopup4 === void 0 ? void 0 : _this$_editPopup4.hide();
          }
        },
