...
var ValidatingController = _uiGrid_core.default.Controller.inherit(function () {
  return {
    ...
    validateGroup: function validateGroup(validationData) {
      ...
      (0, _deferred.when)(((_validationResult = validationResult) === null || _validationResult === void 0 ? void 0 : _validationResult.complete) || validationResult).done(function (validationResult) {
  ...
  extenders: {
    controllers: {
      editing: {
        ...
        _needInsertItem: function _needInsertItem(change) {
        ...
        processItems: function processItems(items, changeType) {
          ...
          if (that.getEditMode() === EDIT_MODE_BATCH && changeType !== 'prepend' && changeType !== 'append') {
            changes.forEach(function (change) {
              ...
              if (validationData && change.type && validationData.pageIndex === that._pageIndex && (change === null || change === void 0 ? void 0 : change.pageIndex) !== that._pageIndex) {
