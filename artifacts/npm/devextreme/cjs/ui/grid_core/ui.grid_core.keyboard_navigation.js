...
function isFixedColumnIndexOffsetRequired(that, column) {
  ...
  if (rtlEnabled) {
    result = !(column.fixedPosition === 'right' || (0, _type.isDefined)(column.command) && !(0, _type.isDefined)(column.fixedPosition));
  } else {
    result = !(!(0, _type.isDefined)(column.fixedPosition) || column.fixedPosition === 'left');
  }
...
var KeyboardNavigationController = _uiGrid_core.default.ViewController.inherit({
  ...
  _targetCellTabHandler: function _targetCellTabHandler(eventArgs, direction) {
    ...
    if (!isEditorCell(this, $cell) && $lastInteractiveElement.length && eventTarget !== $lastInteractiveElement.get(0)) {
      ...
      if (this._focusedCellPosition.rowIndex === undefined && (0, _renderer.default)(eventTarget).hasClass(ROW_CLASS)) {
        this._updateFocusedCellPosition($cell);
      }
      ...
      if (this.isRowFocusType()) {
        ...
        if (elementType === 'row' && isDataRow((0, _renderer.default)(eventTarget))) {
  ...
  _resetFocusedCell: function _resetFocusedCell(preventScroll) {
    ...
    this._focusedCellPosition = {};
    clearTimeout(this._updateFocusTimeout);
    (_this$_focusedView = this._focusedView) === null || _this$_focusedView === void 0 ? void 0 : _this$_focusedView.renderFocusState(preventScroll);
  },
  ...
  extenders: {
    views: {
      rowsView: {
        ...
        renderFocusState: function renderFocusState(preventScroll) {
          var keyboardController = this.getController('keyboardNavigation');
