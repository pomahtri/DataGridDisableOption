...
var baseFixedColumns = {
  ...
  _createCell: function _createCell(options) {
    ...
    if (_browser.default.mozilla && options.column.fixed && options.rowType !== 'group' && !isRowAltStyle) {
  ...
  _renderCellContent: function _renderCellContent($cell, options) {
    ...
    var isGroupCell = options.rowType === 'group' && (0, _type.isDefined)(column.groupIndex); // T747718, T824508, T821252
