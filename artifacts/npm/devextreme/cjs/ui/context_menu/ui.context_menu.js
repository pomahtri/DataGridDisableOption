...
var ContextMenu = /*#__PURE__*/function (_MenuBase) {
  ...
  _proto._closeOnOutsideClickHandler = function _closeOnOutsideClickHandler(e) {
  ...
  _proto._show = function _show(event) {
    ...
    if (position) {
      ...
      this._setAriaAttributes(); // T983617. Prevent the browser's context menu appears on desktop touch screens.
