      ...
      (0, _uiPivot_grid.foreachTree)(headerItems, function (items) {
        ...
        if (!item.children || item.children.length === 0) {
          ...
          for (i = 0; i < cellDescriptions.length; i++) {
            ...
            var columnIsHidden = cellDescriptions[i].visible === false || isGrandTotal && (0, _array.inArray)(i, options.hiddenGrandTotals) !== -1 || isTotal && (0, _array.inArray)(i, options.hiddenTotals) !== -1 || isValue && (0, _array.inArray)(i, options.hiddenValues) !== -1;
