...
var FallbackLayoutStrategy = /*#__PURE__*/function () {
  ...
  _proto3.renderBox = function renderBox() {
    this._$element.css({
      fontSize: 0,
  ...
  _proto3.renderAlign = function renderAlign() {
  ...
  _proto3._setItemsMargins = function _setItemsMargins($items, direction, shift) {
  ...
  _proto3.renderCrossAlign = function renderCrossAlign() {
    var $items = this._$items;
  ...
  _proto3._chooseMarginSide = function _chooseMarginSide(value) {
  ...
  _proto3.renderItems = function renderItems($items) {
    var _this = this;
  ...
  _proto3._totalBaseSize = function _totalBaseSize() {
    var _this2 = this;
  ...
  _proto3.initSize = function initSize() {
...
var Box = /*#__PURE__*/function (_CollectionWidget) {
  ...
  _proto4._getDefaultOptions = function _getDefaultOptions() {
  ...
  _proto4._defaultOptionsRules = function _defaultOptionsRules() {
  ...
  _proto4._itemClass = function _itemClass() {
    return BOX_ITEM_CLASS;
  };

  _proto4._itemDataKey = function _itemDataKey() {
    return BOX_ITEM_DATA_KEY;
  };

  _proto4._itemElements = function _itemElements() {
  ...
  _proto4._initLayout = function _initLayout() {
  ...
  _proto4._initBoxQueue = function _initBoxQueue() {
    this._queue = this.option('_queue') || [];
  };

  _proto4._queueIsNotEmpty = function _queueIsNotEmpty() {
    return this.option('_queue') ? false : !!this._queue.length;
  };

  _proto4._pushItemToQueue = function _pushItemToQueue($item, config) {
    this._queue.push({
      $item: $item,
      config: config
    });
  ...
  _proto4._shiftItemFromQueue = function _shiftItemFromQueue() {
    return this._queue.shift();
  };

  _proto4._initMarkup = function _initMarkup() {
  ...
  _proto4._renderActions = function _renderActions() {
    this._onItemStateChanged = this._createActionByOption('onItemStateChanged');
  };

  _proto4._renderAlign = function _renderAlign() {
    this._layout.renderAlign();

    this._layout.renderCrossAlign();
  };

  _proto4._renderItems = function _renderItems(items) {
    var _this3 = this;
  ...
  _proto4._renderItemContent = function _renderItemContent(args) {
  ...
  _proto4._postprocessRenderItem = function _postprocessRenderItem(args) {
  ...
  _proto4._createItemByTemplate = function _createItemByTemplate(itemTemplate, args) {
  ...
  _proto4._visibilityChanged = function _visibilityChanged(visible) {
    if (visible) {
      this._dimensionChanged();
    }
  };

  _proto4._dimensionChanged = function _dimensionChanged() {
  ...
  _proto4._dispose = function _dispose() {
    clearTimeout(this._updateTimer);

    _CollectionWidget.prototype._dispose.apply(this, arguments);
  };

  _proto4._itemOptionChanged = function _itemOptionChanged(item, property, value, oldValue) {
    if (property === 'visible') {
  ...
  _proto4._optionChanged = function _optionChanged(args) {
    switch (args.name) {
  ...
  _proto4._itemOptions = function _itemOptions() {
    var _this4 = this;
  ...
  _proto4.repaint = function repaint() {
    this._dimensionChanged();
  }
  /**
