...
var FileUploader = /*#__PURE__*/function (_Editor) {
  ...
  _proto._updateEventTargets = function _updateEventTargets(e) {
  ...
  _proto._filterFiles = function _filterFiles(files) {
    if (!files.length) {
      return files;
    }
...
var ChunksFileUploadStrategyBase = /*#__PURE__*/function (_FileUploadStrategyBa) {
  ...
  _proto4._shouldHandleError = function _shouldHandleError(error) {};
...
var DefaultChunksFileUploadStrategy = /*#__PURE__*/function (_ChunksFileUploadStra) {
  ...
  _proto5._shouldHandleError = function _shouldHandleError(e) {
...
var CustomChunksFileUploadStrategy = /*#__PURE__*/function (_ChunksFileUploadStra2) {
  ...
  _proto6._shouldHandleError = function _shouldHandleError(e) {
    return true;
  };
...
var WholeFileUploadStrategyBase = /*#__PURE__*/function (_FileUploadStrategyBa2) {
  ...
  _proto7._shouldHandleError = function _shouldHandleError(file, e) {};

  _proto7._handleProgress = function _handleProgress(file, e) {
    if (file._isError) {
      return;
    }
...
var DefaultWholeFileUploadStrategy = /*#__PURE__*/function (_WholeFileUploadStrat) {
  ...
  _proto8._shouldHandleError = function _shouldHandleError(file, e) {
