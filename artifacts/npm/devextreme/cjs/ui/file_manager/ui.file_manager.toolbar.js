...
var FileManagerToolbar = /*#__PURE__*/function (_Widget) {
  ...
  _proto._ensureAvailableCommandsVisible = function _ensureAvailableCommandsVisible(toolbar, fileItems) {
    var _this8 = this;
  ...
  _proto._setItemVisibleAvailable = function _setItemVisibleAvailable(item, fileItems) {
  ...
  _proto._fileToolbarHasEffectiveItems = function _fileToolbarHasEffectiveItems(fileItems) {
    var _this9 = this;
  ...
  _proto._isToolbarItemAvailable = function _isToolbarItemAvailable(toolbarItem, fileItems) {
  ...
  _proto._isFileToolbarItemAvailable = function _isFileToolbarItemAvailable(_ref2, fileItems) {
    var name = _ref2.name,
  ...
  _proto.update = function update(fileItems) {
