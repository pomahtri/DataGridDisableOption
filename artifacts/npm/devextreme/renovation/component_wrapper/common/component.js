...
var ComponentWrapper = /*#__PURE__*/function (_DOMComponent) {
  ...
  _proto._fireContentReady = function _fireContentReady() {
    ...
    (_this$option = this.option("onContentReady")) === null || _this$option === void 0 ? void 0 : _this$option({
      component: this,
  ...
  _proto._patchOptionValues = function _patchOptionValues(options) {
    ...
    [].concat(_toConsumableArray(props), ["onContentReady"]).forEach(function (propName) {
  ...
  _proto.getProps = function getProps() {
    ...
    var _this$option2 = this.option(),
        elementAttr = _this$option2.elementAttr;
    ...
    return _extends({}, options, this.elementAttr, elementAttr, {
      className: [].concat(_toConsumableArray((this.elementAttr.class || "").split(" ")), _toConsumableArray(((elementAttr === null || elementAttr === void 0 ? void 0 : elementAttr.class) || "").split(" "))).filter(function (c, i, a) {
  ...
  _proto.getDefaultTemplates = function getDefaultTemplates() {
    var names = this.getDefaultTemplateNames();
    var result = {};
  ...
  _proto._optionChanged = function _optionChanged(option) {
    var fullName = option.fullName,
        name = option.name,
        value = option.value;
    (0, _updatePropsImmutable.updatePropsImmutable)(this._props, this.option(), name, fullName);
