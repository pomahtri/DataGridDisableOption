      ...
      editing: {
        ...
        optionChanged: function optionChanged(args) {
          if (args.name === 'editing' && this.isFormOrPopupEditMode()) {
            ...
            if ((fullName === null || fullName === void 0 ? void 0 : fullName.indexOf(EDITING_POPUP_OPTION_NAME)) === 0) {
              if (editPopup) {
        ...
        getEditFormTemplate: function getEditFormTemplate() {
          return ($container, detailOptions, renderFormOnly) => {
            ...
            this._editForm.on('contentReady', () => {
              ...
              (_this$_editPopup4 = this._editPopup) === null || _this$_editPopup4 === void 0 ? void 0 : _this$_editPopup4.repaint();
            });
          };
        },
