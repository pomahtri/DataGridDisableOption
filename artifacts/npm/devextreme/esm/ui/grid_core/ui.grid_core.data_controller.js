    ...
    data: modules.Controller.inherit({}).include(DataHelperMixin).inherit(function () {
        ...
        if (dataSource) {
          if (value !== undefined) {
            if (dataSource[optionName]() !== value) {
              ...
              return dataSource[optionName === 'pageIndex' ? 'load' : 'reload']().done(that.pageChanged.fire.bind(that.pageChanged));
            }
      ...
      var members = {
        ...
        _processItems: function _processItems(items, change) {
          ...
          var dataIndex = isDefined(lastVisibleItem === null || lastVisibleItem === void 0 ? void 0 : lastVisibleItem.dataIndex) ? lastVisibleItem.dataIndex + 1 : 0;
          var options = {
