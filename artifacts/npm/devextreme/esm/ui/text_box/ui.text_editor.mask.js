...
var TextEditorMask = TextEditorBase.inherit({
  ...
  _initMaskStrategy: function _initMaskStrategy() {
    this._maskStrategy = isInputEventsL2Supported() ? new InputEventsMaskStrategy(this) : // FF, old Safari and desktop Chrome (https://bugs.chromium.org/p/chromium/issues/detail?id=947408)
