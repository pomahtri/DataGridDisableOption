    ...
    return this.callBase().concat([{
      ...
      options: {
        width: function width() {
          ...
          return (window === null || window === void 0 ? void 0 : (_window$visualViewpor = window.visualViewport) === null || _window$visualViewpor === void 0 ? void 0 : _window$visualViewpor.width) || $(window).width();
        },
        position: {
          at: 'bottom center',
          my: 'bottom center',
      ...
      options: {
        width: function width() {
          ...
          return (window === null || window === void 0 ? void 0 : (_window$visualViewpor2 = window.visualViewport) === null || _window$visualViewpor2 === void 0 ? void 0 : _window$visualViewpor2.width) || $(window).width();
        }
      }
    }, {
