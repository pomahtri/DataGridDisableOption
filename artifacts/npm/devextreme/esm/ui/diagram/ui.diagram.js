...
import EdgesOption from './diagram.edges_option'; // STYLE diagram
...
class Diagram extends Widget {
  ...
  _getShapeTexts() {
    ...
    texts[ShapeTypes.ArrowLeftRight] = messageLocalization.format('dxDiagram-shapeArrowLeftRight'); // Flowchart
    ...
    texts[ShapeTypes.SummingJunction] = messageLocalization.format('dxDiagram-shapeSummingJunction'); // Containers
    ...
    texts[ShapeTypes.HorizontalContainer] = messageLocalization.format('dxDiagram-shapeHorizontalContainer'); // Shapes with images
