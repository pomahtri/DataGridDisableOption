...
SeriesDataSource.prototype = {
  ...
  getBoundRange: function getBoundRange() {
    ...
    if (!valRange.isEmpty() && !argRange.isEmpty()) {
      ...
      rangeVisibleSizeY = (isNumeric(valRange.maxVisible) ? valRange.maxVisible : valRange.max) - (isNumeric(valRange.minVisible) ? valRange.minVisible : valRange.min); // B253717
