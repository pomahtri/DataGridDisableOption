...
var logAbsValue = base => value => value === 0 ? 0 : mathLog(mathAbs(value), base);
...
function logarithmicGenerator(options) {
  ...
  var absFloor = value => value < 0 ? mathCeil : mathFloor;

  var absCeil = value => value < 0 ? mathFloor : mathCeil;
