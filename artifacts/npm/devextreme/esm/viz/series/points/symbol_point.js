...
export default {
  ...
  getMinValue: function getMinValue(noErrorBar) {
    ...
    if (errorBarOptions && !noErrorBar) {
      ...
      var lowValue = displayMode !== 'high' && _isDefined(this.lowError) ? this.lowError : this.value;
      var highValue = displayMode !== 'low' && _isDefined(this.highError) ? this.highError : this.value;
