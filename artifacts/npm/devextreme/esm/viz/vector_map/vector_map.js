...
var dxVectorMap = BaseWidget.inherit({
  ...
  _initElements: function _initElements() {
    ...
    that._dataExchanger = new DataExchanger(); // The `{ eventTrigger: that._eventTrigger }` object cannot be passed to the Projection because later backward option updating is going to be added.
...
export default dxVectorMap; // PLUGINS_SECTION
